...
| 10 | §5 | **Aucune dependance ajoutee.** Le choix d'un modele passe par `ActionSheetIOS`, du coeur de React Native | Un vrai `UIAlertController`, donc la direction iOS 26 appliquee telle qu'ecrite : le chrome appartient au systeme, configure et non peint. Une liste de modeles est exactement ce a quoi sert une feuille d'action |
