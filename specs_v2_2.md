...
- **[v2.4] Ce que porte la ligne.** La marque et la quantité se suivent sur une seule ligne, séparées par une virgule ; l'une ou l'autre peut manquer. Une quantité exprimée en portion montre entre parenthèses ce à quoi elle revient — « 2 tranches (50 g) » — parce que la ligne du dessous énonce toujours les calories pour 100, et qu'une portion sans grammes à côté ne s'y compare pas. Les calories de la quantité s'affichent à gauche du bouton : elles appartiennent à l'action, c'est le prix du toucher.
