...
- **[v2.4] Un seul chiffre de calories par ligne.** Là où la ligne porte un bouton d'ajout, les calories pour 100 disparaissent : deux nombres de calories sur une même carte, et aucun n'est manifestement celui qu'on lit. Elles restent dans la bibliothèque, qui n'a pas de bouton — c'est le seul chiffre qu'on y trouve, énoncé contre la même quantité sur chaque ligne, donc le seul qui permette de comparer deux aliments d'un coup d'œil.
