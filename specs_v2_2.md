...
| 21 | §8.3 | **Une jauge de calories pleine est rouge**, journee comme repas — ce qui remplace le seuil « au-dela de 10 % » du n° 12 et supprime l'etat ambre | Demande explicite, apres essai. L'arc se remplit a l'objectif exact, donc la couleur change au moment meme ou la forme se ferme : un evenement dit deux fois. La bande ambre entre l'objectif et 10 % au-dela n'avait plus ou vivre. Consequence a connaitre : le rouge apparait a 100 % pile, soit a l'objectif ATTEINT, et se lit « il ne reste rien » |
