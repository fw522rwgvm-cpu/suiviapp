...
| 21 | §8.3 | **Trois etats pour la jauge de calories** : accent jusqu'a l'objectif, ambre tant que le depassement tient dans une marge de **50 kcal**, rouge au-dela. Remplace le seuil « au-dela de 10 % » du n° 12 | Demande explicite, apres deux essais. La marge est ABSOLUE et non un pourcentage : 10 % accorde 260 kcal de tolerance a une journee a 2 600 et 140 a une journee a 1 400, donc le mou est maximal la ou l'objectif est le plus dur a tenir. Et le rouge commence APRES l'objectif, pas a l'objectif : une jauge pleine veut dire « il ne reste rien », ce qui est le but atteint — l'y peindre en rouge mettait la couleur d'alarme sur l'instant de la reussite |
