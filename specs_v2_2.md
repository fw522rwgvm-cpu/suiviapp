...
| 4 | **§7 (direction iOS 26)** | **La barre au-dessus du clavier est un conteneur de verre tenant des contrôles de verre**, comme iOS 26 en bâtit une | Demande explicite, Safari cité en référence, puis recherche demandée sur la composition réelle. Elle était une surface peinte avec un filet ; des capsules flottantes, puis une dalle de verre, ont été essayées et n'étaient pas plus justes. **Ce qui manquait est `UIGlassContainerEffect`** : Apple ne pose pas *un* matériau derrière une barre — chaque contrôle porte le sien, et le groupe vit dans un conteneur qui laisse les voisins **s'affecter**, fusionnant à l'approche et se séparant en s'éloignant. C'est cette fusion qui est la signature ; des capsules sans elle ont l'air posées dessus, une dalle a l'air de l'ancienne barre. La bande est donc transparente et les contrôles sont le matériau, ce qui est la règle « jamais de fond peint derrière du verre » prise par l'autre bout. **Réserve** : la disposition et les libellés restent dessinés ici — iOS n'expose aucune barre d'accessoire standard à demander |
