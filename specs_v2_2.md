...
| 25 | §8.1, §8.3 | **Appliquer un modele a une journee apparie les repas PAR NOM**, et **recree les repas du modele que la journee n'a plus** (ajoutes en fin). Un repas que le modele ne nomme pas garde son nom et ses entrees et perd ses objectifs | Demande explicite, et elle a revele un defaut plus grave : l'appariement se faisait index a index, donc un repas supprime decalait tout ce qui suivait et les objectifs du diner s'ecrivaient sur la collation — des chiffres plausibles et faux, que rien ne signalait. Le nom peut porter l'appariement depuis que les noms sont une liste fermee avec au plus un exemplaire des trois repas fixes. Ajoutes en fin et non inseres : les positions sont ce par quoi chaque ecriture designe un repas |
