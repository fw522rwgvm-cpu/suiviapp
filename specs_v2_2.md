...
- **[v2.4] Une ligne de récent porte la dernière quantité consommée, et un bouton « + » qui l'ajoute directement au panier.** C'est la même valeur que celle sur laquelle l'écran de quantité s'ouvrirait (pré-remplissage du §8.4), donc la ligne ne peut pas promettre autre chose que ce que son bouton fait. Toucher la ligne ouvre toujours l'écran de quantité : changer la quantité coûte exactement ce qu'il coûtait. Favoris et résultats de recherche n'ont pas ce bouton — un aliment jamais consommé n'a rien à répéter.
