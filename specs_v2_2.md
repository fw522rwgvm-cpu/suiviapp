...
| 4 | **§7 (direction iOS 26)** | **La barre au-dessus du clavier porte le matériau du système**, et les contrôles restent des glyphes et des mots posés dessus | Demande explicite, Safari cité en référence. Elle était une surface peinte avec un filet — la forme d'un accessoire d'avant iOS 26 ; des capsules flottantes ont été essayées d'abord et n'étaient pas plus justes. Ce qu'iOS 26 fait à une barre est de poser **son** matériau derrière et de laisser les contrôles dessus. **Ce n'est pas la règle « jamais de verre dans un en-tête natif » prise à l'envers** — un en-tête porte déjà le matériau d'UIKit, un `InputAccessoryView` est un conteneur vide qu'on remplit. **Réserve inscrite** : « exactement la même » n'est pas atteignable — iOS n'expose aucune barre d'accessoire standard à demander, ni par React Native ni par UIKit hors d'une vue web, d'où vient celle de Safari. Ce qui se partage avec le système est le matériau et les proportions ; le reste est une reconstruction |
