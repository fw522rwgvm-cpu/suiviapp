...
| 4 | **§7 (direction iOS 26)** | **La barre au-dessus du clavier devient des contrôles flottants en Liquid Glass**, chevrons et « OK » | Demande explicite, Safari cité en référence. Elle était une surface pleine avec un filet — la forme d'un accessoire d'avant iOS 26. Sur iOS 26 l'accessoire n'est pas une barre : ce sont des capsules qui flottent au-dessus de la page. **Ce n'est pas la règle « jamais de verre dans un en-tête natif » prise à l'envers** — un en-tête porte déjà le matériau d'UIKit, un `InputAccessoryView` est un conteneur vide qu'on remplit. Là où le matériau manque, la bande se repeint comme avant |
